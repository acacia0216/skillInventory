(function()
{
    return function()
    {
        ...
        this.loadTypedefition = function()
        {
            ...
            this._addService("default_typedef.xml", "Main", "form", "./Main/", "", null, "", "0", "0");
        ...
        {
            // global variable
            this._addVariable("gb_userInfo", null, false);
            this._addVariable("gb_userNo", null, false);
            this._addVariable("gb_searchUser", null, false);
            this._addVariable("gb_modify", null, false);
            this._addVariable("gb_delete", null, false);
            this._addVariable("gb_accessState", null, false);
        ...
        this.on_initApplication = function()
        {
            ...
            // frame
            var mainframe = this.createMainFrame("mainframe", "absolute", "0", "0", "1024", "800", null, null, this);
        ...
        this.mainframe_createBodyFrame = function()
        {
            ...
            this.frame = frame0;
            frame0.set_separatesize("50,2*");

            
            var frame1 = new ChildFrame("ChildFrame0", "absolute", null, null, null, null, null, null, "Main::title.xfdl", frame0);
            frame0.addChild(frame1.name, frame1);
            frame1.set_formurl("Main::title.xfdl");
            frame1.set_showtitlebar("false");
            frame1.set_showtitleicon("false");
            frame1.set_autosize("true");

            var frame2 = new ChildFrame("ChildFrame1", "absolute", null, null, null, null, null, null, "Main::form_main.xfdl", frame0);
            frame0.addChild(frame2.name, frame2);
            frame2.set_formurl("Main::form_main.xfdl");
        ...
        this.loadIncludeScript("SkillInventory.xadl");
    };
}
)();
